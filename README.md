...
2. Открой архив, перенеси контент папки `GalleryView-main` в перенеси в папку с экспортированным чатом
...
- Самостоятельно добавить `const messages = ` в первую строку файла, перед символом `{` и переименовать его в `result.js`
